...
function buildHTML(data) {
    ...
    var str = data.reduce(function(s, row,i){
      if (row[0] && row[1] && row[2]){
        s += '<div class="ui comments"><div class="comment"><a class="ui avatar circular image"><img class="ui avatar image" src="/_layouts/15/media/proxy.ashx?id=cae9d693-2a6d-4ff6-a5a6-29028d2ca0e6&size=50w50h_fxd"></a><div class="content"><a class="author">' +
